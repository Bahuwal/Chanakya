// Upload this code to teensy if you want to see the data with GUI
...
void loop() {
  ...
  // GUI MODE: No debug printing - only binary packets
  // For debug mode with Serial Monitor, use teensy_comm_serial_debug.ino
  // instead

  noInterrupts(); // Disable interrupts
  if (shouldSendPacket()) {
    // Send binary packets for Python GUI (imu_gui.py)
