// Author: Michael Scutari (Modified for Debug Output)
// Description: Read code from LORD Microstrain 3DM-CV7 IMU and FX29 Load Cell.
// Send data over serial with COBS encoding. MODIFIED: Added human-readable
// Serial output for debugging © 2024 General Robotics Lab, Thomas Lord
// Department of Mechanical Engineering, Duke University License: MIT License
...
void loop() {
  ...
  // Print human-readable data at regular intervals
  ...
  if (shouldSendPacket()) {
    // BINARY MODE: Sending packets for Python GUI (imu_gui.py)
    // NOTE: This will show garbage in Serial Monitor. Comment out for debug
    // mode.
